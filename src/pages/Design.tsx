    ...
    <div className="flex h-full flex-col bg-slate-50">
      ...
      <div className="flex-1 overflow-hidden relative flex">
        ...
        <div className="flex-1 bg-slate-200 flex flex-col overflow-hidden">
          <div className="bg-slate-300/30 px-4 py-1.5 text-[10px] font-black text-slate-500 flex justify-between uppercase tracking-widest border-b border-slate-300/50">
            <span>Production Workspace: {CR80_WIDTH_MM} x {CR80_HEIGHT_MM} MM (300 DPI)</span>
